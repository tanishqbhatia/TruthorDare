...
import com.tanishqbhatia.recyclerview.behavior.DragAndDropCallback;
import com.tanishqbhatia.recyclerview.behavior.DragAndDropHelper;
import com.tanishqbhatia.recyclerview.behavior.DragAndDropOptions;
import com.tanishqbhatia.recyclerview.behavior.SnapAlignment;
import com.tanishqbhatia.recyclerview.behavior.StartSnapHelper;
import com.tanishqbhatia.recyclerview.behavior.SwipeDirection;
import com.tanishqbhatia.recyclerview.behavior.SwipeToDismissCallback;
import com.tanishqbhatia.recyclerview.behavior.SwipeToDismissHelper;
import com.tanishqbhatia.recyclerview.behavior.SwipeToDismissOptions;
import com.tanishqbhatia.recyclerview.decoration.DividerItemDecoration;
import com.tanishqbhatia.recyclerview.decoration.GridSpacingItemDecoration;
import com.tanishqbhatia.recyclerview.decoration.LinearSpacingItemDecoration;
import com.tanishqbhatia.recyclerview.decoration.SectionHeaderItemDecoration;
import com.tanishqbhatia.recyclerview.decoration.SectionHeaderProvider;
...
public class CustomRecyclerView extends RecyclerView
  ...
  private void setupLoadMore() {
    ...
    setOnTouchListener(new OnTouchListener() {
      ...
      public boolean onTouch(View v, MotionEvent event) {
        ...
        if (Utils.isScrollable(CustomRecyclerView.this)) {
   ...
   */
  @Override
  public void addCell(@NonNull CustomCell cell) {
    adapter.addCell(cell);
  }

  @Override
  public void addCell(int atPosition, @NonNull CustomCell cell) {
    adapter.addCell(atPosition, cell);
  }

  @Override
  public void addCells(@NonNull List<? extends CustomCell> cells) {
    adapter.addCells(cells);
  }

  @Override
  public void addCells(@NonNull CustomCell... cells) {
    adapter.addCells(cells);
  }

  @Override
  public void addCells(int fromPosition, @NonNull List<? extends CustomCell> cells) {
    adapter.addCells(fromPosition, cells);
  }

  @Override
  public void addCells(int fromPosition, @NonNull CustomCell... cells) {
    adapter.addCells(fromPosition, cells);
  }

  @Override
  public <T extends CustomCell & Updatable> void addOrUpdateCell(@NonNull T cell) {
    adapter.addOrUpdateCell(cell);
  }

  @Override
  public <T extends CustomCell & Updatable> void addOrUpdateCells(@NonNull List<T> cells) {
    adapter.addOrUpdateCells(cells);
  }

  @Override
  public <T extends CustomCell & Updatable> void addOrUpdateCells(@NonNull T... cells) {
    adapter.addOrUpdateCells(cells);
  }

  @Override
  public void removeCell(@NonNull CustomCell cell) {
