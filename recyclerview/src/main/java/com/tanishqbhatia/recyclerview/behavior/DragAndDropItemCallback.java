...
import com.tanishqbhatia.recyclerview.R;
...
class DragAndDropItemCallback extends ItemTouchHelper.Callback {
  ...
  public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
    ...
    if (draggingItemPosition != NO_POSITION) {
      draggingItem = customRecyclerView.getCell(draggingItemPosition).getItem();
    }
  ...
  public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder source, RecyclerView.ViewHolder target) {
    ...
    if (dragAndDropCallback != null) {
      dragAndDropCallback.onCellMoved((CustomRecyclerView) recyclerView, source.itemView, draggingItem, source.getAdapterPosition(), target.getAdapterPosition());
    }
  ...
  public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
    ...
    if (dragAndDropCallback != null) {
      dragAndDropCallback.onCellDragStarted(customRecyclerView, viewHolder.itemView, draggingItem, draggingItemPosition);
    }
  ...
  public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
    ...
    if (dragAndDropCallback != null) {
      if (fromPosition == -1) {
        dragAndDropCallback.onCellDragCancelled((CustomRecyclerView) recyclerView, viewHolder.itemView, draggingItem, draggingItemPosition);
      } else {
        dragAndDropCallback.onCellDropped((CustomRecyclerView) recyclerView, viewHolder.itemView, draggingItem, fromPosition, toPosition);
      }
    }
