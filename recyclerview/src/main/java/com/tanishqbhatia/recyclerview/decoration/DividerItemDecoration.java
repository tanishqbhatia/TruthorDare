...
package com.tanishqbhatia.recyclerview.decoration;
...
import com.tanishqbhatia.recyclerview.CustomAdapter;
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
  ...
  private boolean ignoreDrawDividerForCellTypes(RecyclerView parent, int position) {
    if (noDividerCellTypes == null) {
      noDividerCellTypes = ((CustomRecyclerView) parent).getNoDividerCellTypes();
    }
    ...
    if (isLinearMode(parent)) {
      ...
      String type = ((CustomAdapter) parent.getAdapter()).getCell(pos + position).getClass().getSimpleName();
